...
## **Web3 Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#web3-methods)**

### **`web3_clientVersion`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#web3_clientversion)**

Get the web3 client version.

### **Parameters (0)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-0)**

### **Result[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#result)**

```json
 {"jsonrpc":"2.0","id":1,"result":"hetu/0.1.3+/linux/go1.18"}

```

### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples)**
...
### **`web3_sha3`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#web3_sha3)**

Returns Keccak-256 (not the standardized SHA3-256) of the given data.

### **Parameters (1)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-1)**

1: input `hexutil.Bytes`

- Required: ✓ Yes

### **Result[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#result-1)**
...
### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples-1)**
...
## **Net Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#net-methods)**

### **`net_version`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#net_version)**
...
### **`net_peerCount`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#net_peercount)**
...
### **`net_listening`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#net_listening)**
...
## **Eth Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth-methods)**

### **`eth_protocolVersion`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_protocolversion)**
...
### **`eth_syncing`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_syncing)**
...
### **`eth_gasPrice`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_gasprice)**
...
### **`eth_accounts`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_accounts)**
...
### **`eth_blockNumber`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_blocknumber)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters)**
...
### **`eth_getStorageAt`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getstorageat)**

Returns the storage address for a given account address.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-2)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-3)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-4)**
...
### **`eth_getBlockTransactionCountByHash`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getblocktransactioncountbyhash)**

Returns the total transaction count for a given block hash.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-5)**
...
### **`eth_getCode`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getcode)**

Returns the code for a given account address and Block Number.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-6)**
...
### **`eth_sign`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_sign)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-7)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-8)**
...
### **`eth_sendRawTransaction`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_sendrawtransaction)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-9)**
...
### **`eth_call`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_call)**

Executes a new message call immediately without creating a transaction on the block chain.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-10)**
...
### **`eth_estimateGas`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_estimategas)**

Returns an estimate value of the gas required to send the transaction.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-11)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-12)**
...
### **`eth_getBlockByHash`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getblockbyhash)**

Returns the block info given the hash found in the command above and a bool.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-13)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-14)**
...
### **`eth_getTransactionByBlockHashAndIndex`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_gettransactionbyblockhashandindex)**

Returns transaction details given the block hash and the transaction index.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-15)**
...
### **`eth_getTransactionReceipt`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_gettransactionreceipt)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-16)**
...
### **`eth_newFilter`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_newfilter)**

Create new filter using topics of some kind.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-17)**
...
### **`eth_newBlockFilter`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_newblockfilter)**
...
### **`eth_newPendingTransactionFilter`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_newpendingtransactionfilter)**
...
### **`eth_uninstallFilter`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_uninstallfilter)**

Removes the filter with the given filter id. Returns true if the filter was successfully uninstalled, otherwise false.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-18)**
...
### **`eth_getFilterChanges`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getfilterchanges)**

Polling method for a filter, which returns an array of logs which occurred since last poll.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-19)**
...
### **`eth_getFilterLogs`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getfilterlogs)**

Returns an array of all logs matching filter with given id.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-20)**
...
### **`eth_getLogs`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getlogs)**

Returns an array of all logs matching a given filter object.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-21)**
...
### **eth_coinbase[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_coinbase)**
...
### **eth_getProof[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_getproof)**

Returns the account- and storage-values of the specified account including the Merkle-proof.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-22)**
...
## **WebSocket Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#websocket-methods)**

Read about websockets in  CometBFT Events

### **`eth_subscribe`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_subscribe)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-23)**
...
### **`eth_unsubscribe`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#eth_unsubscribe)**

Unsubscribe from an event using the subscription id

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-24)**
...
## **Personal Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal-methods)**

### **`personal_importRawKey`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_importrawkey)**
...
### **Parameters (2)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-2-1)**
...
### **`personal_listAccounts`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_listaccounts)**
...
### **`personal_lockAccount`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_lockaccount)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-25)**
...
### **`personal_newAccount`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_newaccount)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-26)**
...
### **`personal_unlockAccount`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_unlockaccount)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-27)**
...
### **`personal_sendTransaction`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_sendtransaction)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-28)**
...
### **`personal_sign`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_sign)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-29)**
...
### **`personal_ecRecover`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_ecrecover)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-30)**
...
### **`personal_initializeWallet`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_initializewallet)**
...
### **Parameters (1)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-1-1)**
...
### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples-2)**
...
### **`personal_unpair`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#personal_unpair)**
...
### **Parameters (2)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-2-2)**

- URL
- Pairing password

### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples-3)**
...
## **Debug Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#debug-methods)**

### **`debug_traceTransaction`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#debug_tracetransaction)**

The `traceTransaction` debugging method will attempt to run the transaction in the exact same manner as it was executed on the network. It will replay any transaction that may have been executed prior to this one before it will finally attempt to execute the transaction that corresponds to the given hash.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-31)**
...
### **`debug_traceBlockByNumber`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#debug_traceblockbynumber)**

The `traceBlockByNumber` endpoint accepts a block number and will replay the block that is already present in the database.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-32)**
...
## **Miner Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner-methods)**

### **`miner_getHashrate`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_gethashrate)**
...
### **`miner_setExtra`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_setextra)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-33)**
...
### **`miner_setGasPrice`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_setgasprice)**
...
Make sure your `hetud start` call is not using the flag `minimum-gas-prices`, because this value will be used instead of the one set on the configuration file.

### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-34)**
...
### **`miner_start`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_start)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-35)**
...
### **`miner_stop`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_stop)**
...
### **`miner_setGasLimit`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_setgaslimit)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-36)**
...
### **`miner_setEtherbase`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#miner_setetherbase)**
...
### **Parameters[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-37)**
...
## **TxPool Methods[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#txpool-methods)**

### **`txpool_content`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#txpool_content)**
...
### **Parame (0)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parame-0)**

### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples-4)**
...
### **Result[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#result-2)**
...
### **`txpool_inspect`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#txpool_inspect)**
...
### **Parameters (0)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-0-1)**

### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples-5)**
...
### **Result[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#result-3)**
...
### **`txpool_status`[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#txpool_status)**

Returns the number of transactions currently pending for inclusion in the next block(s), as well as the ones that are being scheduled for future execution only.

### **Parameters (0)[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#parameters-0-2)**

### **Client Examples[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#client-examples-6)**
...
### **Result[](https://docs.evmos.org/develop/api/ethereum-json-rpc/methods#result-4)**
...
The latest  CometBFT RPC documentations can be found [here](https://docs.cometbft.com/v1.0/).  CometBFT supports the following RPC protocols:
...
## **URI/HTTP[](https://docs.evmos.org/develop/api/tendermint-rpc#urihttp)**
...
## **RPC/HTTP[](https://docs.evmos.org/develop/api/tendermint-rpc#rpchttp)**

JSONRPC requests can be POST'd to the root RPC endpoint via HTTP. See the list of supported  CometBFT RPC endpoints using Swagger here.

## **RPC/Websocket[](https://docs.evmos.org/develop/api/tendermint-rpc#rpcwebsocket)**

### **Cosmos and  CometBFT Events[](https://docs.evmos.org/develop/api/tendermint-rpc#cosmos-and-tendermint-events)**

`Event`s are objects that contain information about the execution of the application and are triggered after a block is committed. They are mainly used by service providers like block explorers and wallet to track the execution of various messages and index transactions. You can get the full list of `event` categories and values [here](https://docs.evmos.org/develop/api/tendermint-rpc#list-of-tendermint-events).

More on Events:

- [Cosmos SDK Events](https://docs.cosmos.network/main/learn/advanced/events)

### **Subscribing to Events via Websocket[](https://docs.evmos.org/develop/api/tendermint-rpc#subscribing-to-events-via-websocket)**

 CometBFT Core provides a [Websocket](https://docs.tendermint.com/v0.34/tendermint-core/subscription.html) connection to subscribe or unsubscribe to  CometBFT `Events`. To start a connection with the  CometBFT websocket you need to define the address with the `--rpc.laddr` flag when starting the node (default `tcp://127.0.0.1:26657`):

```bash
hetud start --rpc.laddr="tcp://127.0.0.1:26657"
...
The `type` and `attribute` value of the `query` allow you to filter the specific `event` you are looking for. For example, an Ethereum transaction on Hetu (`MsgEthereumTx`) triggers an `event` of type `hetu` and has `sender` and `recipient` as `attributes`. Subscribing to this `event` would be done like so:
...
### **List of  CometBFT Events[](https://docs.evmos.org/develop/api/tendermint-rpc#list-of-tendermint-events)**
...
### **Example[](https://docs.evmos.org/develop/api/tendermint-rpc#example)**
